...
func (p *ServiceAServiceAArgs) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ServiceAServiceAArgs[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *ServiceAServiceAArgs) FastReadField1(buf []byte) (int, error) {
	offset := 0
	p.Req = NewRequest()
...
// for compatibility
func (p *ServiceAServiceAArgs) FastWrite(buf []byte) int {
	return 0
}

func (p *ServiceAServiceAArgs) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "serviceA_args")
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], binaryWriter)
	}
	offset += bthrift.Binary.WriteFieldStop(buf[offset:])
...
func (p *ServiceAServiceAArgs) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("serviceA_args")
	if p != nil {
		l += p.field1Length()
	}
	l += bthrift.Binary.FieldStopLength()
...
func (p *ServiceAServiceAArgs) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *ServiceAServiceAArgs) field1Length() int {
	l := 0
...
func (p *ServiceAServiceAResult) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ServiceAServiceAResult[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *ServiceAServiceAResult) FastReadField0(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *ServiceAServiceAResult) FastWrite(buf []byte) int {
	return 0
}

func (p *ServiceAServiceAResult) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "serviceA_result")
	if p != nil {
...
func (p *ServiceAServiceAResult) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("serviceA_result")
	if p != nil {
		l += p.field0Length()
	}
	l += bthrift.Binary.FieldStopLength()
...
func (p *ServiceAServiceAResult) fastWriteField0(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	if p.IsSetSuccess() {
...
func (p *ServiceAServiceAResult) field0Length() int {
	l := 0
	if p.IsSetSuccess() {
...
func (p *ServiceAServiceAArgs) GetFirstArgument() interface{} {
	return p.Req
}

func (p *ServiceAServiceAResult) GetResult() interface{} {
	return p.Success
}
